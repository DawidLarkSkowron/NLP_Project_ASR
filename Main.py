...
if uploaded_file is not None:
    with st.spinner("⏳ Przetwarzanie pliku..."):
        ...
        text, srt_content, json_content = save_transcription(result)
        ...
        col1.download_button("📥 Pobierz TXT", text, "transcription.txt", "text/plain")
        col2.download_button("📥 Pobierz SRT", srt_content, "transcription.srt", "text/plain")
        col3.download_button("📥 Pobierz JSON", json_content, "transcription.json", "application/json")
